                ...
                match (&mut self.mode, k.code) {
                    ...
                    (Mode::Normal, code) => {
                        match code {
                            ...
                            KeyCode::Up if k.modifiers.intersects(KeyModifiers::SHIFT) => self.push_action(Action::MoveRow(-1)),
                            KeyCode::Down if k.modifiers.intersects(KeyModifiers::SHIFT) => self.push_action(Action::MoveRow(1)),
